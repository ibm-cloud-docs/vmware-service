...
{{site.data.keyword.atracker_full_notm}} provides an integration with {{site.data.keyword.mon_full_notm}}, which allows you to use a VMware® by Broadcom site provided default dashboard to view metrics for your sites. Alternatively, you can create your own dashboard to visualize performance, volume of usage, and to define alerts to monitor your environment.
